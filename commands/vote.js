...
module.exports = {
	...
	execute(message, args, msgUser, msgGuild, client, logger) {
		...
		if (vote === true) return message.channel.send(embed.setDescription('Vote for Project Neia and get up to 2 extra daily\'s a day.\nTo get the daily\'s just vote [here](https://top.gg/bot/684458276129079320/vote) and then you will receive a DM when Project Neia has received your vote.\nYou can do this every **12** hours!'));
